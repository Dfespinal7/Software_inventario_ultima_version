...
urlpatterns = [
    ...
    path('vista_factura/',vista_factura,name="vista_factura"),
    path('lista_factura/',lista_factura,name="lista_factura"),
    path('Grafica/',Grafica,name="Grafica"),
    path('Grafica/',Grafica,name="inventario_view"),
    ...
    path('editar_usuario<int:idUsuario>/',editar_usuario,name="editar_usuario"),
    path('eliminar_usuario<int:idUsuario>/',eliminar_usuario,name="eliminar_usuario"),
]
